...
#string.digits
#string.punctuation
print("Welcome to our RANDOM CHARACTER DEVELOPER")
print()
length=int(input("PLEASE Enter length of your required CHARACTER:"))
...
#Create password by joining characters
 ...
 print()
 print("character can't have zero digits")
elif length<4:
    print()
    print("character too short")
